...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/resources/js/IDMS/IDMS0331.js?${initParam.version}"></script>
</head>
<body>
	<p id="p_errorMessage" style="color: red; padding-left: 10px">&nbsp;</p>
	<form id="IDMS0331Form" method="post">
		...
		<div id="p11" style="padding-left: 10px;width: 700px;">
			...
			<div id="p" class="easyui-panel" title="登録内容" style="width: 700px; height: auto; padding: 10px;">
				<table cellpadding="2">
					<tr>
						<td style="text-align: left;width: 100px;">兼任開始日</td>
						<td>
					...
					<tr>
						...
						<td>組織&nbsp;<input class="easyui-textbox" type="text"
							id="minorOrganizationName" name="minorOrganizationName" disabled
							style="width:180px" /> <input type="hidden" id="minorOrganizationCd"
							name="minorOrganizationCd" /></td>
					</tr>
					<tr>
						<td/>
						<td>役職&nbsp;<input class="easyui-combobox" id="minorOfficeCd"
							name="minorOfficeCd" style="width:180px" validType="needSelect['#minorOfficeCd']"
							data-options="url:CONTEXT_PATH+'/COMMON/getOfficeList.htm',
										  ...
										  }" /><input type="hidden" id="minorOfficeName"
							name="minorOfficeName" /></td>
					</tr>
				</table>
			</div>
			<br/>
