...
<title>STAR扱者コードメンテナンス画面</title>
<%@include file="../common/head.jsp"%>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/resources/js/IDMS/IDMS0645.js?${initParam.version}"></script>
<script type="text/javascript">
...
<body>
	...
	<form id="IDMS0645Form" method="post">
		<div id="p11" style="padding-left: 10px;width: 700px;">
			<div id="p" class="easyui-panel" title="STAR扱者コード"
				...
				<table cellpadding="2">
					...
					<tr>
						...
						<td>
							...
							id="handlingCd" name="handlingCd"
							data-options="validType:[ 'maxLength[5]' ]" style="width:180px" />
						</td>
					</tr>
					<tr>
						<td>登録ユーザ</td>
