...
<title>契約形態メンテナンス画面</title>
<%@include file="../common/head.jsp"%>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/resources/js/IDMS/IDMS0633.js?${initParam.version}"></script>
<script type="text/javascript">
...
<body>
	...
	<form id="IDMS0633Form" method="post">
		<div id="p11" style="padding-left: 10px;width: 700px;">
			<div id="p" class="easyui-panel" title="契約形態情報"
				style="width: 700px; height: auto; padding: 10px;">
				<table cellpadding="2">
					<tr>
						<td style="text-align: left;width:180px">契約形態コード</td>
						<td>
							<input class="easyui-textbox" type="text"
							id="contractCd" name="contractCd"
					...
					<tr>
						<td >個人フォルダ作成フラグ</td>
						<td><input type="checkbox" id="personalFolderFlag"
							name="personalFolderFlag" value="1">
						</td>
					</tr>
					<tr>
						<td>登録ユーザ</td>
